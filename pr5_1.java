...
Question : WAP to show how to create a file with different mode and 
methods of File class to find
path, directory etc. */
import java.util.*;
import java.io.*;
...
class pr5_1 {
    public static void main(String... args) {
        ...
        try {
            ...
            myObj.write("This is Part 5 Practical 1\nCreated Created By 21CE007 Daksh Bangoria");
            myObj.close();
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
