...
Question : When to use Character Stream over Byte Stream? When to use Byte 
Stream over Character
Stream? Give example.
Ans:Byte streams are used to perform input and output of 8-bit bytes.
 ...
 Character stream is used to perform input and output operations of 16-
bit Unicode.
...
public class pr5_2 {
    ...
    public static void main(String[] args)
        ...
        try {
            // Reading from file
            sourceStream = new FileReader("Part5Practical2.txt");
